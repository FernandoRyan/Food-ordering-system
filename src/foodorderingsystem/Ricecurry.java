 ...
 * @author RYAN
 */
public class Ricecurry extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ricecurry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
